    ...
    <nav class="navbar navbar-color-on-scroll navbar-transparent    fixed-top  navbar-expand-lg "  color-on-scroll="100"  id="sectionsNav">
        <div class="container">
            <div class="navbar-translate">
                <a class="navbar-brand" href="news.php?return='1'"> Logout </a>
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="dropdown nav-item">
                      <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false">
                          <i class="material-icons">apps</i> Notifications
                      </a>
	                ...
	                <div class="col-md-6 ml-auto mr-auto">
        	           <div class="profile">
                            ...
                            <input id="myFileInput" type="file" accept="image/*;capture=camera">
	                          <img src="islam.jpg" alt="Circle Image" class="img-raised rounded-circle img-fluid">
                            <div class="img">
                                <img src="profile_images/<?php echo $user_data->user_image; ?>" alt="Profile image">
                            </div>
	                        </div>
	                        <div class="name">
	                            <h3 class="title"><?php  if (isset($_SESSION['fname']) && isset($_SESSION['lname'])) : ?>
                                <em><?php echo $_SESSION['fname'] ." ". $_SESSION['lname']; ?></em>
                              </h3>

								              <h5><?php  if (isset($_SESSION['username'])) : ?>
            			            <em><?php echo $_SESSION['username']; ?></em></h5><br>

								              <a onclick="document.getElementById('demo').innerHTML=about()" href="#About"><i >About</i></a>

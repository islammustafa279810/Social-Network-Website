  ...
  <div  class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        <li class="active"><a href="news.php">Home</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="prof2.php"><span class="glyphicon glyphicon-user"></span> <?php  if (isset($_SESSION['fname']) && isset($_SESSION['lname'])) : ?>
...
<div class="container text-center">
  <div class="row">
    <div class="col-sm-3 well">
      <div class="well">
        <p><a href="prof2.php"><?php  if (isset($_SESSION['fname']) && isset($_SESSION['lname'])) : ?>
					<?php echo $_SESSION['fname'] ." ". $_SESSION['lname']; ?></a></p>
        <img src="islam.jpg" class="img-circle" height="65" width="65" alt="Avatar">
      </div>
      <div class="well">
    ...
    <div class="col-sm-2 well">
      <div class="thumbnail">
        ...
        <button class="btn btn-primary"  target="_blank" onclick="window.open('https://www.rm-events.org');">Info</button>
      </div>
      <div class="well">
        <p>ADS</p>
      </div>
...
<footer class="container-fluid text-center">
	<p><a href="news.php">Refresh Home</p>
